  ...
  return (
    <Box component="div">
      ...
      <Box>
        ...
        <List>
          <ListItem>
            <ListItemText primary="1. Составить список вещей на сумму которую я назвала" />
          </ListItem>
          <ListItem>
            <ListItemText primary="2. Находите картинки с вещами из вашего списка" />
          </ListItem>
          <ListItem>
            <ListItemText primary="3. Смотрите на картинки по очереди и представляйте как вы покупаете эти вещи" />
          </ListItem>
          <ListItem>
            <ListItemText primary="4. Записывайте в блокнот ощущения которые у вас при этом возникают" />
          </ListItem>
          <ListItem>
